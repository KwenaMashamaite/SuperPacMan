...
namespace SuperPacMan {
    ...
    void ScoreView::init() {
        ...
        oneUpText->getRenderer()->setTextColour(IME::Graphics::Colour::Red);
        ...
        highscoreText->getRenderer()->setTextColour(IME::Graphics::Colour::Red);
        ...
        scoreValue->getRenderer()->setTextColour(IME::Graphics::Colour::White);
        ...
        highscoreValue->getRenderer()->setTextColour(IME::Graphics::Colour::White);
